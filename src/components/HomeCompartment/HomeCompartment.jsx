...
export default function HomeCompartment(props) {
  ...
  return (
    <CompartmentRow>
      <WidthContainer>
        {"title" in data && <CompartmentTitle>{data.title}</CompartmentTitle>}
          ...
          {data.group.map((item) => {
            return (
              ...
              >
                ...
                {"image" in item && (
                  <CompartmentImage src={item.image}></CompartmentImage>
                )}
        ...
        {"button" in data && (
          <CompartmentButton>{data.button}</CompartmentButton>
        )}
